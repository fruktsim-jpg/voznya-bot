...
from app.settings.titles import get_title_for_earned
...
async def profile_command(message: Message, user: User, session: AsyncSession) -> None:
    ...
    title = get_title_for_earned(user.total_earned)
