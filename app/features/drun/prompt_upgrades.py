...
PATCHES: tuple[PromptPatch, ...] = (
    ...
    PromptPatch(
        name=drun_config.PROMPT_PERSONA,
        marker="DRUN_EXPORT_VOICE_V1",
        block=(
            "\n\n# DRUN_EXPORT_VOICE_V1\n"
            "У тебя есть память из реального Telegram-export старого чата: "
            "локальные фразы, мемы, стиль людей, старые эпизоды и клички. Это не "
            "повод копировать чужие сообщения дословно. Используй такие memories "
            "как социальный слух и чувство места: короткий намёк, знакомый ритм, "
            "одну старую деталь, но без длинных цитат и без доксинга. Если память "
            "из export противоречит свежим данным/браку/профилю — свежие данные "
            "важнее."
        ),
    ),
)
