...
_DEFAULT_OBSERVATION = (
    "Вкинь одну живую мысль в чат — как тебе вздумается. Можешь зацепиться за "
    "то, о чём болтают люди, наехать на кого-то конкретного по приколу или "
    "просто выдать вознячью дичь. Не отчитывайся о статистике, будь живым."
)
_DEFAULT_REACTION = (
    "Среагируй в образе на то, что сейчас происходит в чате или в мире. "
    "Можешь подколоть участника, поддержать своего или вкинуть мем. Коротко, "
    "по-вознячьи, без пересказа лент и цифр."
)
_DEFAULT_REPLY = (
    "К тебе обратился игрок (его реплика — в самом конце). Ответь как живой "
    "Меллстрой: по сути, в образе, с учётом ДОСЬЕ на него (особенно блок "
    "ТВОЁ ОТНОШЕНИЕ) и того, о чём болтают в чате. Зови людей по нику. "
    "Жёстко, дерзко, можешь обоссать или поддержать — смотря кто перед тобой."
)
