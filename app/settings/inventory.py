...
INV_GIFTS_HINT = (
    "\n💡 Pending-подарки ждут решения. Продать/вывести подарок: на сайте в разделе «Инвентарь» "
...
# Site-first (Release 2.2): кнопка на полный инвентарь сайта (продать/вывести/
# подарить/Premium удобнее там). Команда в боте остаётся быстрым просмотром.
INV_SITE_BTN = "🎒 Управлять инвентарём и подарками"
